...
namespace Proxies\__CG__\Umbrella\ShopBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Umbrella\ShopBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Umbrella\\ShopBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Umbrella\\ShopBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Umbrella\\ShopBundle\\Entity\\Category' . "\0" . 'products');
        }
